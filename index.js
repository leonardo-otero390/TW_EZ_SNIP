    ...
    */
...

    {
        ...
        function onSigilsDoneCreateSnipesAndInterface(incomings, villas) {
            ...
            $output.find('#ezs-manual-sigil').val(parseInt(localStorage.getItem('ezs-last-sigil') || '0'))
            ...
            function makeManualIncomingEntry(newIncoming) {
                var makeTwTimeString = (datetime) => {
                    var time2 = (n) => '0'.repeat(Math.max(0, 2 - n.toString().length)) + n;
                    var time3 = (n) => '0'.repeat(Math.max(0, 3 - n.toString().length)) + n;
                ...
                var $newEntry = $(`
                    <div>
                        To ${newIncoming.destination.name} at ${makeTwTimeString(newIncoming.arrival)} (${newIncoming.destination.speedModifier * 100 || 0}% sigil)
            ...
            $output.find('#ezs-manual-submit').click(() => {
                ...
                var sigilPercent = parseInt($output.find('#ezs-manual-sigil').val() || '0');
